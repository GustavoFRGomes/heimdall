...
from flask.ext.restful import marchal_with
...
class RuleResource(Resource):
    def __init__(self):
        self.reqparser = reqpase.RequestParser()
    ...
    def get(self, id):
        ...
        if not rule:
            abort(404, message="Can't find {0} in the DB.".foramt(id))
        return rule
